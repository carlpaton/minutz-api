...
import { Environments, InjectableDependency, ExtendPackages } from './seed.config.interfaces';
...
export class SeedConfig {
  ...
  */
  ...
  CSS_OPSDEV_PROD_BUNDLE = 'opsdev-bootstrap.css';
  ...
  APP_ASSETS: InjectableDependency[] = [
    ...
    // { src: `${this.JS_DEST}/jquery-3.2.1.slim.min.js`, inject: true, vendor: false },
    //{ src: `${this.JS_DEST}/bootstrap.min.js`, inject: true, vendor: false }
  ];
