...
export class AgendaPanelComponent implements OnInit, OnChanges {
    ...
    @Output() CollectionNotification = new EventEmitter<Array<MeetingAgenda>>();
    ...
    public AddTopic($event: any) {
        ...
        quickTopic.Duration = 100;
        quickTopic.DurationLabel = '1 minute';
        quickTopic.AgendaText = 'Quick item .......';
        this.AgendaCollection.push(quickTopic);
        this.CollectionNotification.emit(this.AgendaCollection);
    }
    public click(): void {
        this.Click.emit();
    }
