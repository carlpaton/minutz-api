...
namespace Core {
  public class MeetingService : IMeetingService {
    ...
    public KeyValuePair<bool, Minutz.Models.ViewModels.MeetingViewModel> CreateMeeting (
      ...
      _logger.LogInformation (Core.LogProvider.LoggingEvents.InsertItem, "CreateMeeting - Service - added owner to attendees ", auth);
      _logger.LogInformation (Core.LogProvider.LoggingEvents.InsertItem, "CreateMeeting - Service - auth ", auth.ConnectionString);
